  ...
  methods: {
    ...
    showAll(event, options, refName) {
      ...
      this.stylePosition = {
        ...
        left: this.mousePointer.x - w + 26 + "px",
      };

      this.NameControlCurrent = refName;

      this.refCurrent = refName;
